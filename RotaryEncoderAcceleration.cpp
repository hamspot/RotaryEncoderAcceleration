...
RotaryEncoderAcceleration::RotaryEncoderAcceleration(uint8_t pinNumberA, uint8_t pinNumberB){
	initialize(pinNumberA, pinNumberB);
}

void RotaryEncoderAcceleration::initialize(uint8_t pinNumberA, uint8_t pinNumberB) {
